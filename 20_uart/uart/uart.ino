 ...
 * Based on code from 
 *
 * Serial Communication in Seeed Studio Getting Started 
 *   at  https://wiki.seeedstudio.com/xiao_esp32c5_pin_multiplexing/#software-3
 * and the SerialPassthrough.ino example in the ESP32 Arduino Core
 * by  Erik Nyquist (23 May 2016) in Examples/04.Communications 
 *
